...
import estisharatibussiness.users.com.ViewHolder.PackageViewHolder
...
//        }
        ...
        Log.d("description++",holder.packageDescription.text.toString()) //        if (packagesItems.features.video.time.equals("0")) {
...
//            val intent = Intent(context, ConsultantsInThePackage::class.java)
//            intent.putExtra("consultants", packagesItems.consultants)
//            intent.putExtra("price",packagesItems.price)
//            context.startActivity(intent)
        }
    }
