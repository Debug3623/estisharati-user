...
import estisharatibussiness.users.com.UtilsClasses.PinOnKeyListener
import estisharatibussiness.users.com.UtilsClasses.PinTextWatcher
...
class ActivityForgotPassword : BaseCompatActivity() {
    ...
    fun initViews() {
        helperMethods = HelperMethods(this@ActivityForgotPassword)
        preferencesHelper = SharedPreferencesHelper(this@ActivityForgotPassword)
        ...
        mCallbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
         ...
         helperMethods.dismissProgressDialog()
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                helperMethods.setStatusBarColor(this@ActivityForgotPassword, R.color.orange)
    ...
    fun clickEvents() {
        ...
        code_1.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 0, editTexts))
        code_2.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 1, editTexts))
        code_3.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 2, editTexts))
        code_4.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 3, editTexts))
        code_5.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 4, editTexts))
        code_6.addTextChangedListener(PinTextWatcher(this@ActivityForgotPassword, 5, editTexts))

        code_1.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 0, editTexts))
        code_2.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 1, editTexts))
        code_3.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 2, editTexts))
        code_4.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 3, editTexts))
        code_5.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 4, editTexts))
        code_6.setOnKeyListener(PinOnKeyListener(this@ActivityForgotPassword, 5, editTexts))
    ...
    private fun signInWithPhoneAuthCredential(credential: PhoneAuthCredential) {
        FirebaseAuth.getInstance().signInWithCredential(credential).addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                ...
                helperMethods.setStatusBarColor(this@ActivityForgotPassword, R.color.white)
            } else {
...
//        }
    ...
    fun forgotPasswordApiCall(phone: String) {
        helperMethods.showProgressDialog(getString(R.string.please_wait_while_loading))
        val responseBodyCall = retrofitInterface.RESET_PASSWORD_API_CALL(phone,"User")
