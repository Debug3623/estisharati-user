...
class LoginAndRegistration : BaseCompatActivity() {
    ...
    fun clickEvents() {
        ...
        nav_forget_password.setOnClickListener { startActivity(Intent(this@LoginAndRegistration, ActivityForgotPassword::class.java)) }
        terms_policy.setOnClickListener {
            if (helperMethods.isConnectingToInternet) {
                val intent = Intent(this@LoginAndRegistration, ActivityPages::class.java)
                    ...
                    if (response.body() != null) {
                        try {
                            ...
                            if (status.equals("200")) {
                                ...
                                val intent = Intent(this@LoginAndRegistration, VerificationActivity::class.java)
