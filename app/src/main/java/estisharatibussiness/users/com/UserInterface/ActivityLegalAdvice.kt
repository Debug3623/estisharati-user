...
import estisharatibussiness.users.com.Adapter.LegalAdviceAdapter
...
import estisharatibussiness.users.com.DataClassHelper.Consultant.ConsultantResponse
import estisharatibussiness.users.com.DataClassHelper.Consultant.Data
...
class
ActivityLegalAdvice : BaseCompatActivity() {
    ...
    fun initViews() {
        helperMethods = HelperMethods(this@ActivityLegalAdvice)
        retrofitInterface = RetrofitApiClient(GlobalData.BaseUrl).getRetrofit().create(RetrofitInterface::class.java)
        sharedPreferencesHelper = SharedPreferencesHelper(this@ActivityLegalAdvice)
    ...
    fun clickEvents() {
        ...
        notificationLayout.setOnClickListener {
            startActivity(Intent(this@ActivityLegalAdvice, Notifications::class.java))
        }
    ...
    fun InitializeRecyclerview() {
        ...
        legal_advice_recycler.layoutManager = LinearLayoutManager(this@ActivityLegalAdvice)
        legal_advice_recycler.adapter = LegalAdviceAdapter(this@ActivityLegalAdvice, this@ActivityLegalAdvice, consultantsArrayList)
    }

    fun initializeFilterSpinner() {
        val typeface = ResourcesCompat.getFont(this@ActivityLegalAdvice, R.font.almarai_regular)
        val adapter = ArrayAdapter(this@ActivityLegalAdvice, R.layout.support_simple_spinner_dropdown_item, sortingOptionsArraylist)
        ...
        v2.setTextColor(ContextCompat.getColor(this@ActivityLegalAdvice, R.color.white))
        legal_filter_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                view.setTextColor(ContextCompat.getColor(this@ActivityLegalAdvice, R.color.white))
