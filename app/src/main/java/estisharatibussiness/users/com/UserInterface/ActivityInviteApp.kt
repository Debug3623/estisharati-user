...
import estisharatibussiness.users.com.DataClassHelper.Referral.ReferralResponse
...
class ActivityInviteApp : AppCompatActivity() {
    ...
    fun initViews() {
        helperMethods = HelperMethods(this@ActivityInviteApp)
        retrofitInterface = RetrofitApiClient(GlobalData.BaseUrl).getRetrofit().create(RetrofitInterface::class.java)
        sharedPreferencesHelper = SharedPreferencesHelper(this@ActivityInviteApp)
