...
import estisharatibussiness.users.com.UserInterfaces.ActivityPackagesSelection
import okhttp3.*
...
class NetwrokPayment {
    fun createOrder(activityPackagesSelection: ActivityPackagesSelection, Token: String, Price: String, language: String) {
        ...
        class OrderClass : AsyncTask<String?, String?, String?>() {
            override fun doInBackground(vararg strings: String?): String? {
                ...
                try {
                    ...
                    Object.put("emailAddress", activityPackagesSelection.sharedPreferencesHelper.logInUser.email)
                    Object.put("language", language)
                    Object.put("merchantOrderReference", "Estisharati-" + activityPackagesSelection.sharedPreferencesHelper.logInUser.id)
                    billingAddress.put("firstName", activityPackagesSelection.sharedPreferencesHelper.logInUser.fname)
                    billingAddress.put("lastName", "" + activityPackagesSelection.sharedPreferencesHelper.logInUser.lname)
                    ...
                    shippingAddress.put("firstName", activityPackagesSelection.sharedPreferencesHelper.logInUser.fname)
                    shippingAddress.put("lastName", "" + activityPackagesSelection.sharedPreferencesHelper.logInUser.lname)
...
//                    .url("https://api-gateway.sandbox.ngenius-payments.com/transactions/outlets/bf13a29c-b0fb-45a4-b329-529ffba307f5/orders")
            ...
            override fun onPostExecute(result: String?) {
                ...
                activityPackagesSelection.lunchPaymentGateway(paymentResponse)
            }
        }
    ...
    fun getToken(activityPackagesSelection: ActivityPackagesSelection) {
        ...
        call.enqueue(object : Callback<AuthResponce?> {
            override fun onResponse(call: Call<AuthResponce?>, resultResponse: retrofit2.Response<AuthResponce?>) {
                ...
                if (response != null) {
                    activityPackagesSelection.callOrderFroPaymentAPI(response.access_token)
                } else {
                    activityPackagesSelection.tokenError("Unable to get token !")
                }
            }

            override fun onFailure(call: Call<AuthResponce?>, t: Throwable) {
                activityPackagesSelection.tokenError("Token onFailure !")
            }
        })
    }
}