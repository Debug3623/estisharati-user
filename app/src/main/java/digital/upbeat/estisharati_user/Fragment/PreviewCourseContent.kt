...
import digital.upbeat.estisharati_user.Adapter.PreviewCourseContentAdapter
import digital.upbeat.estisharati_user.Helper.HelperMethods
import digital.upbeat.estisharati_user.R
import kotlinx.android.synthetic.main.fragment_course_content.*

class PreviewCourseContent : Fragment() {

lateinit var helperMethods: HelperMethods
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_preview_course_content, container, false)
    }
    ...
    fun InitializeRecyclerview() {
        ...
        course_content_recycler.adapter = PreviewCourseContentAdapter(requireContext(), this@PreviewCourseContent, arrayList)
    }
}