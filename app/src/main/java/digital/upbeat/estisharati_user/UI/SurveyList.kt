...
class SurveyList : AppCompatActivity() {
    ...
    fun InitializeRecyclerview() {
        ...
        surveyRecycler.layoutManager = LinearLayoutManager(this@SurveyList)
        surveyRecycler.adapter = SurveyListAdapter(this@SurveyList, this@SurveyList, surveyListResponse.data)
